function vr = collectBehaviorIter_TMazeCYJS(vr, varargin)
% collect behavior on linear track with some changes to match formatting in
% collectBehaviorIter_full used to collect behavior on dynamic switching
% task
global daqData;
lickInfo = daqData(4);
