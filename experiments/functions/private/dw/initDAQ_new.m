...
if ~vr.debugMode
    ...
    %There is no input to ai3
%     h4 = vr.ai.addAnalogInputChannel('dev1','ai3','Voltage');
%     h4.TerminalConfig = 'SingleEnded'; 
    
    h5 = vr.ai.addAnalogInputChannel('dev1','ai5','Voltage'); %lick detector
    h5.TerminalConfig = 'SingleEnded'; %lick detector 
