function vr = waitForNextTrial_LinTrack_CA_Rig2(vr)

if vr.inITI == 1
    
    %vr.worlds{vr.currentWorld}.backgroundColor = [0.5 0.5 0.5];
    vr.worlds{vr.currentWorld}.backgroundColor = [0.69 0.69 0.69]; % 170613: make ITI color same as grey background
