...
if vr.debugMode
    ...
    %vr.basePath = 'D:\DATA\Charlotte'; % new SSD disk for additional space
     vr.basePath = 'E:\DATA\Charlotte'; % new SSD disk for additional space
...
if ~exist(vr.fullPath,'dir')
   ...
   mkdir(vr.fullPath);
   mkdir(vr.fullPathCamera); %commented 170729
