function vr = collectBehaviorIter_PhotoStim(vr)
...
thisIter(11) = vr.PhotoStimInfo; % check whether PhotoStim is on or not
...
vr.behaviorData([1:8,10:11],vr.trialIterations) = thisIter([1:8,10:11])';

vr.behaviorData( 12:14, vr.trialIterations) = mvData(1:3); % record raw ball signal as well
