...
%disp(size(daqData));
data = daqData(1:3) -[1.6505, 1.652, 1.655]%1.333[1.5051    1.4962    1.4965];%-[1.4926    1.4960    1.4966];%-[1.5047    1.4964    1.4961];%- [1.50    1.4960    1.4963];%-[1.493    1.4939    1.4875];% -[1.4916    1.4951    1.4958];
...
alpha = -45/75*circum/V; % changed from 50/
flip = 0; % set to 1 if the mirror flips right and left in Virme9n 
if 0
    disp('using yaw');
