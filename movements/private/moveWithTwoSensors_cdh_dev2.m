function velocity = moveWithTwoSensors_cdh_dev2(vr)
global daqData
global mvData
velocity = [0 0 0 0];
...
%disp(size(daqData));
data = daqData(1:2)-[1.499    1.506];%;% -[1.5051   1.4965];%-[1.4926    1.4960    1.4966];%-[1.5047    1.4964    1.4961];%- [1.50    1.4960    1.4963];%-[1.493    1.4939    1.4875];% -[1.4916    1.4951    1.4958];
